...
CMakeFiles/hydra.dir/Double.cpp.o: CMakeFiles/hydra.dir/flags.make
CMakeFiles/hydra.dir/Double.cpp.o: ../Double.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/admin/Programs/Code/CPP/Artem/hydra/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Building CXX object CMakeFiles/hydra.dir/Double.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/hydra.dir/Double.cpp.o -c /home/admin/Programs/Code/CPP/Artem/hydra/Double.cpp

CMakeFiles/hydra.dir/Double.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/hydra.dir/Double.cpp.i"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/admin/Programs/Code/CPP/Artem/hydra/Double.cpp > CMakeFiles/hydra.dir/Double.cpp.i

CMakeFiles/hydra.dir/Double.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/hydra.dir/Double.cpp.s"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/admin/Programs/Code/CPP/Artem/hydra/Double.cpp -o CMakeFiles/hydra.dir/Double.cpp.s

CMakeFiles/hydra.dir/fraction.cpp.o: CMakeFiles/hydra.dir/flags.make
CMakeFiles/hydra.dir/fraction.cpp.o: ../fraction.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/admin/Programs/Code/CPP/Artem/hydra/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Building CXX object CMakeFiles/hydra.dir/fraction.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/hydra.dir/fraction.cpp.o -c /home/admin/Programs/Code/CPP/Artem/hydra/fraction.cpp

CMakeFiles/hydra.dir/fraction.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/hydra.dir/fraction.cpp.i"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/admin/Programs/Code/CPP/Artem/hydra/fraction.cpp > CMakeFiles/hydra.dir/fraction.cpp.i

CMakeFiles/hydra.dir/fraction.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/hydra.dir/fraction.cpp.s"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/admin/Programs/Code/CPP/Artem/hydra/fraction.cpp -o CMakeFiles/hydra.dir/fraction.cpp.s
...
hydra: CMakeFiles/hydra.dir/Double.cpp.o
hydra: CMakeFiles/hydra.dir/fraction.cpp.o
hydra: CMakeFiles/hydra.dir/build.make
hydra: CMakeFiles/hydra.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/admin/Programs/Code/CPP/Artem/hydra/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "Linking CXX executable hydra"
